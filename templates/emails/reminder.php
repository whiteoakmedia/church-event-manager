...
<p>This is a friendly reminder that <strong><?php echo esc_html($event_title); ?></strong> is coming up!</p>
...
<p style="margin-top:24px;font-size:13px;color:#888;">
  Can't make it? Please cancel as soon as possible so we can offer your spot to someone on the waitlist:<br>
